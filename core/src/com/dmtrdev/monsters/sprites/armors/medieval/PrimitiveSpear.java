...
public class PrimitiveSpear extends Armor{

    private final boolean mDirection;

    public PrimitiveSpear(final PlayScreen pPlayScreen, final float pX, final float pY, final boolean pDirection) {
        super(pPlayScreen, pX, pY, pDirection);
        setRegion(DefenderOfNature.getArmorsAtlas().findRegion("spear_type_one"));
    ...
    public int getArmorDamage() {
        return ConstArmor.PRIMITIVE_SPEAR_DAMAGE;
    }
