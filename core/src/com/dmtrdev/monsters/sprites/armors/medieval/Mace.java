...
public class Mace  extends Armor {

    public Mace(final PlayScreen pPlayScreen, final float pX, final float pY, final boolean pDirection) {
        super(pPlayScreen, pX, pY, pDirection);
        setRegion(DefenderOfNature.getArmorsAtlas().findRegion("mace"));
        setSize(ConstArmor.SPIKE_CLUB_WIDTH, ConstArmor.SPIKE_CLUB_HEIGHT);
        setOriginCenter();
    ...
    public void collisionEnemy() {
        setToDestroy = true;
        setSize(ConstArmor.EFFECT_MEDIUM_SIZE - 0.1f, ConstArmor.EFFECT_MEDIUM_SIZE);
    }
