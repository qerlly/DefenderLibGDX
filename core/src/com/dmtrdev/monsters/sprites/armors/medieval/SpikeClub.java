...
public class SpikeClub extends Armor {

    public SpikeClub(final PlayScreen pPlayScreen, final float pX, final float pY, final boolean pDirection) {
        super(pPlayScreen, pX, pY, pDirection);
        setRegion(DefenderOfNature.getArmorsAtlas().findRegion("spike_club"));
    ...
    public int getArmorDamage() {
        return ConstArmor.SPIKE_CLUB_DAMAGE;
    }
